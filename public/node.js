...
app.post('/process_post',urlencodedParser, function (req, res) {
    var response = { sellerID:req.body.sellerID, sellerName:req.body.sellerName, productName:req.body.productNameseller, Quantity:req.body.quantitySell, Product_address:req.body.productAddress, Rate:req.body.sellrate};
...
app.post('/process_post1',urlencodedParser, function (req, res) {
    response = { buyer_name:req.body.buyerName,   productName:req.body.productNamebuyer, Quantity:req.body.quantityPurchase, delivery_address:req.body.deliveryAddress};
...
app.post('/process_post2',urlencodedParser, function (req, res) {
    response = { sellerID:req.body.sellerID, sellerName:req.body.sellerName, productName:req.body.productNameseller, Quantity:req.body.quantitySell, Product_address:req.body.productAddress, Rate:req.body.sellrate};
    MongoClient.connect('mongodb://localhost:27017/', function(err, db){
        if (err)
            throw err;
        console.log("Connected to Database");
...
app.post('/process_post5',urlencodedParser, function (req, res) {
    response = { buyer_name:req.body.buyerName,   productName:req.body.productNamebuyer, Quantity:req.body.quantityPurchase1, delivery_address:req.body.deliveryAddress1};
    MongoClient.connect('mongodb://localhost:27017/', function(err, db){
        if (err)
            throw err;
        console.log("Connected to Database");
...
app.post('/process_post6',urlencodedParser, function (req, res) {
    response = { sellerName:req.body.name,   seller_ID:req.body.UserID, email:req.body.email, address:req.body.address, email:req.body.email, contact:req.body.Contact};
    MongoClient.connect('mongodb://localhost:27017/', function(err, db){
        if (err)
            throw err;
        console.log("Connected to Database");
